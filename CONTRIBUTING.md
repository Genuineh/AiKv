...
PR 提交后将自动触发 GitHub Actions CI 检查. 所有流水线 (Lint、Test、Security、Docs Link Check) 全绿且 Maintainer Review 通过后, 方可以 **Squash and merge** 方式合并回 `main`. 详细的 CI Job 编排与说明见 [`.github/CI.md`](.github/CI.md).

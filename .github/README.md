...
>
> **aidb 依赖**: `Cargo.toml` 声明 GitHub `main` 分支依赖, CI 消费提交的 lockfile; 本地开发通过 `~/.cargo/config.toml` 的 `[patch."https://github.com/wiqun/AiDb.git"]` 覆盖为本地 path (见 [README.md §与 AiDb](../README.md#与-aidb)).

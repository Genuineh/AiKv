...
```json
{
  "glob_pattern": "aidb/archive/16-readme.md"
}
```
...
```json
{
  "glob_pattern": "aikv/e2e/README.md"
}
```
...
```json
{
  "glob_pattern": "aikv-oldmain/**/README*"
}
```
...
```json
{
  "glob_pattern": "aikv-oldmain/docs/guide/*"
}
```
...
```json
{
  "glob_pattern": "WiQunTools/docs/wiqun-kv-inventory/*.md"
}
```
...
```json
{
  "glob_pattern": "wiqun-kv/README.md"
}
```
...
```json
{
  "glob_pattern": "aikv/CONTRIBUTING.md"
}
```
...
```json
{
  "glob_pattern": "aikv/CHANGELOG.md"
}
```

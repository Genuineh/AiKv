...
系统分层与工作原理 (How) 见 [ARCHITECTURE.md](../ARCHITECTURE.md); 存储与共识内核底层实现见 [AiDb 设计决策](https://github.com/wiqun/AiDb/blob/main/docs/design.md); 各模块源码地图见 [docs/modules/](modules/).

...
pub async fn generate(
    ...
    generate_with_engine(project_dir, deploy_type, output_dir, "memory", _template).await
}
...
# enabled = true
# node_id = "n{}"
# peers = ["aikv1:16379", "aikv2:16380", "aikv3:16381", "aikv4:16382", "aikv5:16383", "aikv6:16384"]
"#,
        node_num, port, storage_engine, node_num
    )
}
